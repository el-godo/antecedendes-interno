...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE usuario SET nombre=%s, usuario=%s, contrasena=%s, dni=%s, tipo=%s WHERE id_usuario=%s",
	      ...
	      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
		    <table align="center">
              <tr valign="baseline">
                ...
                <td width="495" align="left"><input type="text" name="usuario" value="<?php echo htmlentities($row_Usuario['usuario'], ENT_COMPAT, 'iso-8859-1'); ?>" readonly="readonly" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="right">Nombre:</td>
                <td align="left"><span id="sprytextfield1">
                  <input type="text" name="nombre" value="<?php echo htmlentities($row_Usuario['nombre'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" />
              ...
              <tr valign="baseline">
                ...
                <input type="text" name="dni" value="<?php echo htmlentities($row_Usuario['dni'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" />
                <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="right">Tipo de Usuario:</td>
                <td align="left"><select name="tipo" id="tipo" >
                  <option value="" <?php if (!(strcmp("", $row_Usuario['tipo']))) {echo "selected=\"selected\"";} ?>>Seleccione una opci&oacute;n</option>
                  <option value="entrada" <?php if (!(strcmp("entrada", $row_Usuario['tipo']))) {echo "selected=\"selected\"";} ?>>entrada</option>
                  <option value="archivo" <?php if (!(strcmp("archivo", $row_Usuario['tipo']))) {echo "selected=\"selected\"";} ?>>archivo</option>
                  <option value="confeccion" <?php if (!(strcmp("confeccion", $row_Usuario['tipo']))) {echo "selected=\"selected\"";} ?>>confeccion</option>
                  <option value="admin" <?php if (!(strcmp("admin", $row_Usuario['tipo']))) {echo "selected=\"selected\"";} ?>>admin</option>
</select>
                </td>
              </tr>
              <tr valign="baseline">
