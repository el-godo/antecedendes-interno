...
if ((isset($_GET['id_dependencia'])) && ($_GET['id_dependencia'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dependencia WHERE id_dependencia=%s",
                       GetSQLValueString($_GET['id_dependencia'], "int"));
...
$Dependencia = mysql_query($query_Dependencia, $antecedentes) or die(mysql_error());
		  ...
		  <div class="full_w">
            ...
            <table border="1">
              <tr>
                ...
                <td><h3>Acci&oacute;n:</h3></td>
              </tr>
              <?php do { ?>
                <tr>
                  <td align="justify"><?php echo $row_Dependencia['descripciondependencia']; ?></td>
                  <td><a href="eliminar_dependencia.php?id_dependencia=<?php echo $row_Dependencia['id_dependencia']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')">Eliminar</a></td>
                </tr>
