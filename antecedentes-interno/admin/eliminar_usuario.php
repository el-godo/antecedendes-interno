            ...
            <table border="1">
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td align="center"><a href="eliminar_usuario.php?ID=<?php echo $row_Usuario['id_usuario']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')">Eliminar</a></td>
                </tr>
