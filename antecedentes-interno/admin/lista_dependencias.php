	...
	<div id="content">
       ...
       <div id="main">
		  <div class="full_w">
            ...
            <table border="1">
              <tr>
                <td width="332"><h3>Dependencia:</h3></td>
                <td width="302"><h3>Acci&oacute;n:</h3></td>
              </tr>
              <?php do { ?>
                <tr>
                  <td align="justify"><?php echo $row_Dependencia['descripciondependencia']; ?></td>
                  <td><a href="editar_dependencia.php?id=<?php echo $row_Dependencia['id_dependencia']; ?>">Editar</a></td>
                </tr>
                <?php } while ($row_Dependencia = mysql_fetch_assoc($Dependencia)); ?>
            </table>
<br />
            <?php echo $totalRows_Dependencia ?> Registros Total </div>
	    </div>
