       ...
       <div id="main">
		  <div class="full_w">
            ...
            <table border="1" align="center">
              <tr>
                <td width="131">Apellido y Nombres</td>
                <td width="130">Nombre de Usuario</td>
                <td width="160">DNI</td>
                <td width="126">Tipo</td>
                <td width="69">Acci&oacute;n</td>
              </tr>
              <?php do { ?>
                <tr>
                  ...
                  <td><a href="editar_usuario.php?ID=<?php echo $row_Usuario['id_usuario']; ?>">Editar</a></td>
                </tr>
                <?php } while ($row_Usuario = mysql_fetch_assoc($Usuario)); ?>
            </table>
            <br />
            <?php echo $totalRows_Usuario ?> Registros Total </div>
	    </div>
