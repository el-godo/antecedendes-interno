...
$query_Solicitudes = "SELECT * FROM solicitud WHERE estado_solicitud = 'Confeccion' ORDER BY fecha_solicitada ASC";
	...
	<div id="content">
		...
		<div id="main">
		  <div class="full_w">
            ...
            <h1>Listado de Solicitudes en Confecci&oacute;n</h1>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <table border="1">
              <tr>
