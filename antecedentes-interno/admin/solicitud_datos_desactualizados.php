...
<!-- Funcion para solo numeros y/o letras-->
 ...
 <style type="text/css">
 .wrap #content #main .full_w table tr td {
	text-align: left;
}
 </style>
 <!-- InstanceEndEditable -->
...
<div class="wrap">
	...
	<div id="content">
		...
		<h1>Procesar Solicitud - Datos desactualizados.</h1>
		<h3>La solicitud nro: (<?php echo $row_Lista_Solicitud['id_solicitud']; ?>) </h3>
		<h3>No puede procesarse, debido a que los datos de la persona en el legajo se encuentran desactualizados.</h3>
        <h3>Debe dirigirse personalmente a la División Antecedentes en la ciudad capital para solicitar el certificado presentando:</h3>
        <p>&nbsp;</p>
        <table width="200">
          <tr>
            <td><h4>* 2 Fotos 4x4</h4>
              <h4> * Si cambi&oacute; de domicilio deber&aacute; traer fotocopia de DNI 1ra y 2da hoja con domicilio actualizado, en lo contrario certificado de residencia.</h4>
            <h4>* Si cambi&oacute; su estado civil deber&aacute; traer fotocopia del acta o sentencia que acredite tal situaci&oacute;n.</h4></td>
          </tr>
        </table>
        <p>&nbsp;</p>
  ...
  <tr>
    ...
    <td><?php echo $row_Lista_Solicitud['nombre']; ?></td>
		...
		<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
		    ...
		    <input name="estado_solicitud" type="hidden" id="estado_solicitud" value="Datos Desactualizados" />
