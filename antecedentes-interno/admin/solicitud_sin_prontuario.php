...
<div class="wrap">
	...
	<div id="content">
        ...
        <div id="main">
          ...
          <div align="left">
          <h1>Procesar Solicitud - Persona sin prontuario.</h1>
		<h3>La solicitud nro: (<?php echo $row_Lista_Solicitud['id_solicitud']; ?>) </h3>
		<h3>No puede procesarse, debido a que no existe el prontuario de la persona.</h3>
        <h3>Debe dirigirse personalmente a la División Antecedentes en la ciudad capital para solicitar el certificado.</h3>
          </div>
          <br />		
		<table width="100%" border="0">
		  <tr>
		    <td width="147" align="center">DNI</td>
		    <td width="191" align="center">Apellido</td>
		    <td width="298" align="center">Nombres</td>
	      </tr>
		  <tr>
		    <td align="centrar"><?php echo $row_Lista_Solicitud['dni']; ?></td>
		    <td align="centrar"><?php echo $row_Lista_Solicitud['apellido']; ?></td>
		    <td align="centrar"><?php echo $row_Lista_Solicitud['nombre']; ?></td>
	      </tr>
		  </table>
		...
		<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
		    ...
		    <input name="estado_solicitud" type="hidden" id="estado_solicitud" value="Sin Prontuario" />
