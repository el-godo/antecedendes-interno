...
$MM_authorizedUsers = "admin,super";
...
<?php
	  ...
	  mysql_query("INSERT INTO usuario (nombre, usuario, contrasena, dni, iniciales) VALUES ('$apeynom', '$usu', '$pass', '$docu', '$iniciales')");
	  ?> 
...
<div class="wrap">
	...
	<div id="content">
        ...
        <div id="main">
		  <div class="full_w"><!-- InstanceBeginEditable name="EditRegion3" --><div class="h_title">Alta de Usuario</div>
          <div class="Table"><h3 align="center">Los datos se ingresaron correctamente.</h3></div>
