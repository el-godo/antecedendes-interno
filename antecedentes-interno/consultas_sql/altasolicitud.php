...
<?php
	  ...
	  $solicitado=$_POST["solicitado_por"];
	  ...
	  mysql_query("INSERT INTO solicitud (dni, apellido, nombre, tipo_prontuario, prontuario, estado_solicitud, fecha_solicitada, hora_solicitada, usuario, ip_solicitante) VALUES ('$documento', '$apellido', '$nombres', '$tipo_prontuario', '$prontuario', '$estado_soli', 
'$fec', '$hora', '$usuario', '$ip_cliente') ", $antecedentes) or die("Error en consulta <br>MySQL 
dice: 
".mysql_error());
// Recupero el ultimo id:
$ultimo_id_solicitud = mysql_insert_id();
...
<ul>
	...
	<div id="content">
		...
		<div id="main">
		  <div class="full_w"><!-- InstanceBeginEditable name="EditRegion1" --><div class="h_title">Alta de Solicitud</div>
          <div class="Table"> <div><h3 align="center">Los datos se ingresaron correctamente.</h3>
            <p align="center">&nbsp;</p>
