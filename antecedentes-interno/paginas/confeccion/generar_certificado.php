	...
	<div id="content">
		...
		<div id="main">
		  <div class="full_w"><!-- InstanceBeginEditable name="EditRegion1" -->
		    <h1>Generar Certificado Nuevos, del Interior y Urgentes</h1>
		    <p>&nbsp;</p>
		    <form id="form1" name="form1" method="post" action="verificar_solicitud.php">
		      <p>Ingrese el DNI:
                <label for="DocumentoNro"></label>
                <span id="sprytextfield1">
                <input name="DocumentoNro" type="text" autofocus="autofocus" id="DocumentoNro" />
		    ...
		    <h4>En esta secci&oacute;n se podr&aacute; Generar Certificados Para Prontuarios Nuevos, del Interior y Pedidos Urgentes.</h4>
		    <h4>Los que ingresaron por Mesa de Entrada deber&aacute;n procesarse por <a href="listado_solicitudes.php">Imprimir Ingresados por Mesa de Entrada.</a></h4>
	      <p>&nbsp;</p>
		  <script type="text/javascript">
