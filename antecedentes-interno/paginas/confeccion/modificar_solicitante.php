...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE padron SET Apellido=%s, Nombre=%s, Clase=%s, DocumentoNro=%s, IdPais=%s, Genero=%s, EstadoCivil=%s, Profesion=%s, Direccion=%s, ProntuarioNro=%s, Observaciones=%s WHERE IdPadron=%s",
  ...
  $updateGoTo = "correcto.php?dni=" .$_POST['DocumentoNro'];
  if (isset($_SERVER['QUERY_STRING'])) {
          ...
          <table width="643" align="center">
            ...
            <tr valign="baseline">
              ...
              <td><span id="sprytextfield1">
                <input name="DocumentoNro" type="text" value="<?php echo htmlentities($row_Editar_Solicitante['DocumentoNro'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" readonly="readonly" />
                <br />
                <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
              <td>Nacionalidad:</td>
...
?>
            ...
            <tr valign="baseline">
              ...
              <td><span id="sprytextfield5">
                <input type="text" name="Profesion" value="<?php echo htmlentities($row_Editar_Solicitante['Profesion'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" style="text-transform:uppercase;" onchange="conMayusculas (this)"/>
            ...
            <tr valign="baseline">
              ...
              <td><span id="sprytextfield6">
                <input name="Direccion" type="text" style="text-transform:uppercase;" onchange="conMayusculas (this)" value="<?php echo htmlentities($row_Editar_Solicitante['Direccion'], ENT_COMPAT, 'iso-8859-1'); ?>" size="50" maxlength="70"/>
              <br /><span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
...
?>
              ...
              <td><span id="sprytextfield7">
                <input type="text" name="ProntuarioNro" value="<?php echo htmlentities($row_Editar_Solicitante['ProntuarioNro'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" />
              <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
            </tr>
            <tr valign="baseline">
