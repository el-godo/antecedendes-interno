...
<ul>
	...
	<div id="content">
		...
		<div id="main">
		  <div class="full_w"><!-- InstanceBeginEditable name="EditRegion1" --><div id=”stylized” class=”myform”>

 <form id="form1" name="form1" method="post" action="verificado.php">

<h1>Formulario de Solicitud</h1>
<h3>Verificar Solicitante</h3>
<br />
...
<input name="dni" type="text" autofocus="autofocus" id="dni" />
<br />
<label for="dni"></label>
